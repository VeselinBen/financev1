...
import com.Test.back.security.TokenUtils;
import com.Test.back.service.UserService;
import com.Test.back.support.KorisnikDtoToKorisnik;
import com.Test.back.support.KorisnikToKorisnikDto;
import com.Test.back.web.dto.AuthKorisnikDto;
import com.Test.back.web.dto.KorisnikDTO;
import com.Test.back.web.dto.KorisnikPromenaLozinkeDto;
import com.Test.back.web.dto.KorisnikRegistracijaDTO;
...
public class KorisnikController {
    ...
    public ResponseEntity<KorisnikDTO> create(@RequestBody @Validated KorisnikRegistracijaDTO dto){
        ...
        User user = toKorisnik.convert(dto);
...
//        }
        ...
        user.setLozinka(encodedPassword);

        return new ResponseEntity<>(toKorisnikDto.convert(korisnikService.save(user)), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<KorisnikDTO> update(@PathVariable Long id, @Valid @RequestBody KorisnikDTO korisnikDTO){
        ...
        User user = toKorisnik.convert(korisnikDTO);

//        if(korisnik.getAdresa()  == null) {
//            return new ResponseEntity<>(HttpStatus.BAD_REQUEST);			NEMA KLASE ADRESA
//        }

        return new ResponseEntity<>(toKorisnikDto.convert(korisnikService.save(user)),HttpStatus.OK);
    }
